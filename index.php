...
<html lang="en">
  ...
  ?>
            ...
            <!-- <div class="row intro py-1>
              <div class="col-sm-12 col-md"> -->
                <div class="heading text-center my-5">
                  <h3> Welcome to</h3>
                  <h1>SYNCHRONY BANK</h1>
    
          <p class="lead muted">Money transfer just a click away</p>
                </div>
              </div>
      ...
      <!-- Activity section -->
            <div class="row activity text-center">
                  <div class="col-md act">
                    <img src="img/users1.jpg" class="img-fluid">
                    <br>
                  ...
                  <div class="col-md act">
                    <img src="img/histories.jpg" class="img-fluid">
                    <br>
      ...
      <footer class="text-center mt-5 py-2">
        <p>&copy 2021. <b>SYNCHRONY BANK</b> <br> Preeti Vishwakarma | The Sparks Foundation</p>
      </footer>
